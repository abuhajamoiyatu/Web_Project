...
if (isset($_POST["login_Submit"])) {
    if (isset($_POST['email']) && isset($_POST['password'])) {
        ...
        if (empty($__email)) {
            ...
            echo '<h4 class="text-danger text-center">Email is long</h4>';
            $error_exists = true;
        ...
        if (empty($__password)) {
            ...
            $error_exists = true;
        }elseif (strlen($__password) < 10 || strlen($__password) > 50) {
        ...
        if (!$error_exists) {
            ...
            if ($stmt = $con->prepare($sql)) {
                ...
                if ($stmt->execute()) {
                    //This will Store the result below
                    $stmt->store_result();

                    // Check the email if first,then verify your password
                    if ($stmt->num_rows == 1) {

                        // Now Bind in the result variables
...
if (isset($_POST["registerSubmit"])) {
    ...
    try {
        if (isset($_POST["full_name"]) && isset($_POST["email"]) && isset($_POST["password"])) {
            ...
            if (strlen($_password) < 10 || strlen($_password) > 50) {
    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-md-12 text-center">
                <h2 class="display-3">Medical Management System</h2>
            </div>
